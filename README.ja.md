...
- コマンド `Mamori Inspector: Enable Save Formatters` と `Mamori Inspector: Disable Save Formatters` は、設定 UI を開かずにワークスペースフォルダー単位で `mamori-inspector.saveCheckSkipFormatters` を切り替えます。
